...
const NeedToKnow = () => {
  ...
  return (
    <section id="features" className="scroll-mt-28">
      <div className="bg-secondary text-white px-4 sm:px-8 lg:px-16 py-12 sm:py-16 lg:py-20 rounded-4xl">
        ...
        <div className="mb-16 sm:mb-20 lg:mb-24 space-y-10 md:space-y-0 md:flex justify-between items-end">
          <Reveal className="md:w-[60%]" variant="fadeUp">
        ...
        {/* Service Cards Grid */}
        <Stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {/* QR Code Card */}
          <StaggerItem>
      ...
      <div className="w-full mt-2 bg-[#e8f5b8] rounded-4xl px-4 py-16 md:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto">
          <Reveal variant="fadeUp">
            <h2 className="text-secondary font-normal text-4xl md:text-6xl lg:text-7xl xl:text-8xl leading-tight tracking-tight">
              Africa&apos;s Leading QR Customer Interaction Platform
            </h2>
          </Reveal>
          <Reveal variant="fadeUp" delay={0.08}>
            <p className="mt-6 text-secondary/80 text-base md:text-xl max-w-4xl leading-relaxed">
      ...
      <div className="w-full bg-secondary">
        <div className="">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            {/* Left side - Image */}
            <Reveal className="relative h-64 md:h-96 lg:h-full" variant="fadeRight">
              <Image
            ...
            <div className="flex flex-col justify-center px-6 md:px-12 lg:px-16 py-12 lg:py-24">
              <div className="space-y-8">
                ...
                {/* Email Form */}
                <Reveal className="relative max-w-[466px]" variant="fadeUp" delay={0.12}>
                  <input
                    type="email"
                    placeholder="Enter your email"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    className="w-full h-[73px] px-4 py-3 rounded-full bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-primary focus:bg-white/20 transition-all"
                  />
                  <button
                    onClick={handleSubmit}
                    className="absolute h-[53px] top-1/2 -translate-y-1/2 right-2 px-8 py-3 bg-primary text-secondary rounded-full font-medium hover:bg-primary/90 transition-colors whitespace-nowrap"
                  >
                    Proceed
                  </button>
                </Reveal>
