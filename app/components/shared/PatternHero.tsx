    ...
    <section className={className}>
      <div className="relative w-full h-96 lg:h-[420px] overflow-hidden bg-[#0B0B0B]">
        ...
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute -right-24 bottom-0 h-48 w-48 rounded-full border border-primary/30" />
          ...
          <div className="absolute left-1/2 top-0 h-32 w-px -translate-x-1/2 bg-linear-to-b from-white/10 to-transparent" />
          ...
          <div className="absolute left-1/2 bottom-0 hidden sm:block h-20 w-20 -translate-x-1/2 translate-y-1/2 rounded-full bg-primary/25 blur-2xl" />
